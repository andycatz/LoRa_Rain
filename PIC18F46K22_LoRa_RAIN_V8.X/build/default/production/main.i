...
uint16_t batt=0;
uint16_t temp=0;
uint8_t address[8] = {0xE6,0xBA,0x08,0xFB,0x3A,0x4F,0x5E,0xCE};
...
txData[24]=(uint8_t)((tips>>24)&0xFF);
txData[25]=(uint8_t)((tips>>16)&0xFF);
txData[26]=(uint8_t)((tips>>8)&0xFF);
txData[27]=(uint8_t)((tips & 0xFF));
